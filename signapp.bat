...
jar cfmv mctpo.jar manifest.mf bin/com/atlan1/mctpo/*.class res bin/com/atlan1/mctpo/WGen/*.class bin/com/atlan1/mctpo/Texture/*.class bin/com/atlan1/mctpo/Inventory/*.class bin/com/atlan1/mctpo/Listener/*.class
